...
public byte[] decodeDataFrame(byte[] bytes){
  ...
  for(int i=6;i<bytes.length;i++){
    decode[i-6]= PApplet.parseByte(bytes[i] ^ masks[ (i-6) % 4 ]); 
  }
...
public byte[] makeHandshakeValue(String ClientKey1,String ClientKey2, byte[] ClientKey3) throws NoSuchAlgorithmException,UnsupportedEncodingException {
...
public byte[] draft76_getPart(String key) {
